        ...
        <div id="fade-cadastro" class="hide">
            ...
            <div id="modal-cadastro" class ="modal hide">
                    ...
                    <!-- Modal conteudo -->
                    <div class="flex flex-col p-6 space-y-6 w-11/12 h-3/5 mt-2 sm:mb-10 content-center justify-items-center mx-auto lg:mt-6 sm:w-5/6 sm:h-4/6 ">
                        <button class= "h-3/6">
                            ...
                            <img src="img/cliente-icon.svg" class="w-10 mr-4"  alt="">
                                <div class="text-left">
                                    <span class="flex-1 text-xl lg:text-2xl">Cliente   |  Cadastro</span>
                        ...
                        <a href="login.php?" class="flex items-center p-6 text-base font-bold text-gray-900 rounded-lg border border-gray-200 hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white h-full">
                                ...
                                <div class="text-left">
                                    <span class="flex-1 text-xl lg:text-2xl">Profissional   |  Cadastro</span>
                                    <p class="text-lg leading-relaxed text-gray-400 dark:text-gray-400 lg:text-xl">

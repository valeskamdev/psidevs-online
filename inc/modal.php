        ...
        <div id="fade" class="hide">
            ...
            <div id="modal" class ="modal hide">
                    ...
                    <div class="flex flex-col p-6 space-y-6 w-11/12 h-3/5 justify-center mx-auto">
                        <button class= "h-2/5">
                            <a href="login.php?" class="flex items-center p-3 text-base font-bold text-gray-900 rounded-lg bg-gray-50  dark:border-gray-600 hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white h-full">
                        ...
                        <button class= "h-2/5">
                            <a href="login.php?" class="flex items-center p-3 text-base font-bold text-gray-900 rounded-lg bg-gray-50 hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white h-full">
                                <img src="img/github.png" class="w-10 mr-4"  alt="">
                                <div class="text-left">

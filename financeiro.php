...
<head>
    ...
    <title>Finanças | Psidevs online</title>
...
<body>
  ...
  <div class="card-fin">
    ...
    <div class="sessoes">
      <h2>R$ 0,00</h2>
      <p>
        sessões corporativas e subsidiadas
        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 24 24">
        <path d="M 12 2 C 6.4889971 2 2 6.4889971 2 12 C 2 17.511003 6.4889971 22 12 22 C 17.511003 22 22 17.511003 22 12 C 22 6.4889971 17.511003 2 12 2 z M 12 4 C 16.430123 4 20 7.5698774 20 12 C 20 16.430123 16.430123 20 12 20 C 7.5698774 20 4 16.430123 4 12 C 4 7.5698774 7.5698774 4 12 4 z M 11 7 L 11 9 L 13 9 L 13 7 L 11 7 z M 11 11 L 11 17 L 13 17 L 13 11 L 11 11 z"></path>
        </svg>
      </p>
    ...
    <div class="detalhamento">
      <table>
        <caption>Detalhamento de todas as sessões</caption>
        <thead>
          <tr>
            <th>Data da Sessão</th>
            <th>Nome do paciente</th>
            <th>Valor bruto sessão não corporativa</th>
            <th>Valor bruto sessão não corporativa subsidiada</th>
            <th>Valor bruto sessão corporativa</th>
            <th>Valor bruto sessão corporativa e subsidiada final (NF ou RPA)</th>
          </tr>
        </thead>
        <tbody>
          <tr>

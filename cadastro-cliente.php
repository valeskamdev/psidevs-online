...
<head>
    ...
    <title>Cadastro Clinte | Psidevs</title>
...
<body class="body-cadastro-cliente">
    <main class="main-cadastro-cliente">
        <div class="container-cadastro-cliente">
            <div class="form-img-cadastro-cliente">
                <img src="img/cadastro-cliente.png" alt="">
            </div>

            <div class="form-cadastro-cliente">
                <form method="post">
                    <div class="form-header">
                        <h2>Bem Vindo(a) ao Psidev!</h2>
                        <p>Venha conhecer os nossos serviços</p>
                    </div>
                    <div class="relative z-0 w-full mb-6 group">
                        <input type="text" name="nome-cliente" id="nome-cliente" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                    ...
                    <div class="relative z-0 w-full mb-6 group">
                        <input type="email" name="email-cliente" id="email-cliente" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                        <label for="email-cliente" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Email</label>
                    </div>

                    <div class="relative z-0 w-full mb-6 group">
                        <input type="tel" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" name="telefone" id="telefone" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                    ...
                    <div class="text-center">
                        <button type="submit" name="cadastro-cliente" class="button-cadastro-cliente"><b>Enviar</b></button>
                    </div>
                    ...
                    <div class="flex items-center mb-4">
                        ...
                        <label for="lembrar-senha" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Lembrar Senha</label>
                    </div>
            </div>
            </form>
        </div>

  ...
  <main>
      ...
      <section class="servicos-img-texto">
        ...
        <section class="servicos-cards">
          <article data-aos="flip-left">
            <div class="servicos-icons">
              <div class="icon-servicos">
                <img src="assets/icon-relacionamento.svg" alt="">
              </div>
              <div class="bg-positivo">
                <img src="assets/icon-positivo.svg" alt="">
              </div>
            </div>
            <div>
          ...
          <article data-aos="flip-left">
            <div class="servicos-icons">
              <div class="icon-servicos">
                <img src="assets/icon-ansiedade.svg" alt="">
              </div>
              <div class="bg-positivo">
                <img src="assets/icon-positivo.svg" alt="">
              </div>
          ...
          <article data-aos="flip-left">
            <div class="servicos-icons">
              <div class="icon-servicos">
                <img src="assets/icon-casal.svg" alt="">
              </div>
              <div class="bg-positivo">
                <img src="assets/icon-positivo.svg" alt="">
              </div>
          ...
          <article data-aos="flip-left">
            <div class="servicos-icons">
              <div class="icon-servicos">
                <img src="assets/icon-psicologicos.svg" alt="">
              </div>
              <div class="bg-positivo">
                <img src="assets/icon-positivo.svg" alt="">
              </div>
    ...
    <section class="diferenciais limitador">
      ...
      <div data-aos="fade-up" class="separador">
        <img src="assets/icon-barra-servicos.svg" alt="">
      </div>
      <div data-aos="fade-up" class="diferenciais-tipo">
        <span>25+</span>
      ...
      <div class="nos-escolher-img-texto">
        <div class="nos-escolher-texto">
          <article data-aos="fade-up">
            <div>
              <img src="assets/icon-instrumento-moderno.svg" alt="">
            </div>
          ...
          <article data-aos="fade-up">
            <div>
              <img src="assets/icon-cartao.svg" alt="">
            </div>
            <div class="nos-escolher-conteudo">
              <h3>Facilidade para encontrar profissionais</h3>
              <p>
                Encontrar psicólogos é simples em nosso site. Com apenas alguns cliques, você acessa
                uma variedade de perfis qualificados. Navegue, compare e escolha o psicólogo perfeito para o seu
                bem-estar.
              </p>
            </div>
          </article>
          <article data-aos="fade-up">
            <div>
              <img src="assets/icon-profissionais.svg" alt="">
            </div>
            <div class="nos-escolher-conteudo">
    ...
    <article class="depoimentos limitador">
      ...
      <div class="depoimentos-cards">
        <article class="depoimentos-cliente" data-aos="zoom-in">
          <img src="assets/icon-comentario.svg" alt="">
          <p>
